...
namespace ScheduleAdminTool.UI.MVC.Controllers
{
    public class ScheduledClassesController : Controller
    {
        ...
        {
            var scheduledClasses = db.ScheduledClasses.Include(s => s.Cours).Include(s => s.Instructor).Include(s => s.ScheduledClassStatus);
        ...
        public ActionResult Create([Bind(Include = "ScheduledClassId,CourseId,StartDate,EndDate,InstructorId,Loaction,SCSID")] ScheduledClass scheduledClass)
        {
            ...
            ViewBag.InstructorId = new SelectList(db.Instructors, "InstructorId", "FirstName", scheduledClass.InstructorId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduledClassId,CourseId,StartDate,EndDate,InstructorId,Loaction,SCSID")] ScheduledClass scheduledClass)
        {
            if (ModelState.IsValid)
            {
