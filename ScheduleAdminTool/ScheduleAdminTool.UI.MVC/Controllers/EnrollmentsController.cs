...
namespace ScheduleAdminTool.UI.MVC.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduledClassId", "Loaction");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,ScheduledClassId,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduledClassId", "Loaction", enrollment.ScheduledClassId);
